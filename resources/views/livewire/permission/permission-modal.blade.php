        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_update_permission_form" class="form" action="#" wire:submit="submit">
                    ...
                    <!--begin::Input group - Model Name Dropdown-->
                    <div class="fv-row mb-7">
                        <label class="fs-6 fw-semibold form-label mb-2">
                            <span class="required">Module Name</span>
                            <span class="ms-2" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Module names is required.">
                                {!! getIcon('information','fs-7') !!}
                            </span>
                        </label>
                        <select class="form-select form-select-solid" name="module_name" wire:model="module_name">
                            <option value="">Select Module</option>
                            @foreach($modules as $model)
                                <option value="{{ $model->rid }}" data-mnn="{{ $model->mnn }}">{{ $model->mnm }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="fv-row mb-7">
                        <label class="fs-6 fw-semibold form-label mb-2">
                            ...
                            <span class="ms-2" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Component names is required.">
                                {!! getIcon('information','fs-7') !!}
                            </span>
                        </label>
                        <select class="form-select form-select-solid" name="component_name" wire:model="component_name">
                            <option value="">Select Component</option>
                            @foreach($components as $model)
                                <option value="{{ $model->rid }}" data-mnn="{{ $model->cnn }}">{{ $model->cnm }}</option>
                            @endforeach
                        </select>
                        @error('component_name') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <!--end::Input group-->
