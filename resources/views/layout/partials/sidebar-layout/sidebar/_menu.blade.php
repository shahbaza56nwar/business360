		...
		<div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
            ...
            @if (userHasModuleAccess(10))
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('user-management.*') ? 'here show' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <!--begin:Menu item-->
                        @if (userHasPermission('user_home'))
                            <div class="menu-item">
                                <!--begin:Menu link-->
                        ...
                        <!--begin:Menu item-->
                        @if (userHasPermission('role_home'))
                            <div class="menu-item">
                                <!--begin:Menu link-->
			...
			<!--begin:Menu item (hrm management)-->
            @if (userHasModuleAccess(11))
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        @if (userHasPermission('recruit_home'))
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('hrm_recruit_home') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
